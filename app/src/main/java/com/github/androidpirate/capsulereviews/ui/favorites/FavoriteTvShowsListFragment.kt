...
class FavoriteTvShowsListFragment :
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_favorite_tv_shows_list, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        viewModel.favoriteTvShows.observe(viewLifecycleOwner, Observer {
            if(it != null){
    ...
    override fun onPagerItemClick(itemId: Int) {
        val action = FavoritesFragmentDirections.actionFavoriteTvShowsListToDetail(itemId)
