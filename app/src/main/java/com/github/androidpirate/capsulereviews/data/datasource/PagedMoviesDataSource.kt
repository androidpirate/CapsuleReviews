...
class PagedMoviesDataSource(
    ...
    private suspend fun getPagedMoviesWithGenericSort(page: Int, genericSort: GenericSortType): NetworkMoviesResponse {
    ...
    private suspend fun getPagedMoviesWithGenre(page: Int, genre: GenreType, sort: SortType): NetworkMoviesResponse {
